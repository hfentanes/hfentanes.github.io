...
const switchLength = function (element) {
    ...
    const shortDescription = short(elParagraph.innerHTML, 140);
...
const addShortifySystem = function (element) {
    const elButton = element.querySelector("button");
